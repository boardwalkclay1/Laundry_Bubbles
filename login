...
<head>
  <meta charset="UTF-8" />
  <title>Login – Laundry Bubbles</title>
...
<body>
  ...
  <div class="card">
    ...
    <p class="footer">
      ...
      <a class="link" href="/signup.html">Create one</a>
    </p>
  </div>
  ...
  <script type="module">
    ...
    document.getElementById("loginBtn").onclick = async () => {
      ...
      try {
        ...
        if (!snap.exists()) {
          errorBox.textContent = "Account profile not found.";
          return;
        }
